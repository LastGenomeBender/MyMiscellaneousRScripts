...
for(i in 1:length(all_files)) {
  setwd(paste0("/media/ahadli/Data/Farid/AOG_lab/Rna Editing GIREMI/SNV_AG_analysis/A-to-I GIREMI Colon CCLE/filtered files/",names(all_files)[i]))
  mat = all_files[[i]]
...
save(all_count_etypes,
 ...
 chrwise_etype_dist,
 hedited_genes, all_files, file,hedited_genes_AG, file  = "/media/ahadli/Data/Farid/AOG_lab/Rna Editing GIREMI/all_lists.RData")
