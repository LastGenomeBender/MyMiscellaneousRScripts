...
#################### for t1s
t1_brca = cbind(t1_brca,t2_brca,V_brca)
t1_norm = cbind(t1_norm, t2_norm, V_norm)
...
write.csv(t1_brca_ttest, "NSCLC_ttest_al.csv")
t1_brca_ttest = t1_brca_ttest[t1_brca_ttest$"Log2FC">1,] ## and fc 1.5
...
write.csv(t1_brca_ttest_BH, "AllNSCLC_BH_significant_FC1.csv")
