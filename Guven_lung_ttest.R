...
t1_brca = read.csv("Guven_T1_Lung_TCGA.csv", row.names = 1)
t2_brca = read.csv("Guven_T2_Lung_TCGA.csv", row.names = 1)
...
write.csv(file = "Guven_T1_Lung_ttest.csv", t1_brca_ttest)
